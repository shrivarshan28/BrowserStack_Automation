...
BROWSERSTACK_USERNAME = 'shrivarshang_XzgO9u'
BROWSERSTACK_ACCESS_KEY = 'tpDuk6AKVDVNsoYBzGZN'


def run_test(capabilities):
    capabilities['project'] = 'ElPais Website Demo'
    capabilities['build'] = 'Demo Build'
